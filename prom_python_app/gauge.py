...
REQUEST_INPROGRES = Gauge('app_request_inprogress', 'number of application requests in progress')
...
class HandleRequests(http.server.BaseHTTPRequestHandler):
    @REQUEST_INPROGRES.track_inprogress()
    def do_GET(self):
        #REQUEST_INPROGRES.inc()
        time.sleep(5)
